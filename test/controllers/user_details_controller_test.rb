...
class UserDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_detail" do
    assert_difference("UserDetail.count") do
      post user_details_url, params: { user_detail: { is_admin: @user_detail.is_admin, last_name: @user_detail.last_name, name: @user_detail.name, phone_number: @user_detail.phone_number, user_id: @user_detail.user_id } }
    end
  ...
  test "should update user_detail" do
    patch user_detail_url(@user_detail), params: { user_detail: { is_admin: @user_detail.is_admin, last_name: @user_detail.last_name, name: @user_detail.name, phone_number: @user_detail.phone_number, user_id: @user_detail.user_id } }
