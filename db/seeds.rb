...
{question: 'تشکر', answer: 'خواهش میکنم '},
  { question: ' خدمات یا خدمت دارین ', answer: 'ما اشپز خانه سیار استیم ' },
    ...
    {question: 'در قیمت های یا نرخ ها ۲۰۰ مینیو ید ', answer: 'بلی شما از بخش مینیو میتوانید انرا بیبینید '},
    ...
    {question: ' شما مینیو های قبل از قبل ساخته شده  ', answer: 'بلی محترم داریم شما از بخش مینیوهای از قبل ساخته شده آنرا پیدا کرده میتوانید '},
    ...
    {question: 'قیمت ترین یا بهترین  قیمت اش ت ', answer: 'بهترین و قیمت ترین مینیو ما ۱۲۰۰ افغانی قیمت دارد و شما میتوانید از قسمت ریکومندیشن سرچ کنید'},
    ...
    {question: ' با قیمت مناسب یا متوسط را برایم بگو یا پیشنهاد کو ', answer: 'مینیو با قیمت مناسب به ۳۷۰ افغانی است و منیو عالی میباشد شما میتوانید از قسمت ریکومندیشن فیلتر کنید'},
